...
- Predictive Scoring Specification v0.1: reference implementation remediated; synthetic rerun completed with `0/40` strict cross-start agreement, so spec freeze remains blocked
- Tension Bridge: implementation wired; inactive pending a separately frozen `T_obs`/`D_obs` discriminant-validity pilot
