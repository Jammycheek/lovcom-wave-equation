...
| F-08 | optimizer-identification failure | The corrected frozen rerun achieved strict convergence in `31/40` replicates: stable `19/20`, oscillatory `12/20`. All 31 converged fits recovered the generating local-regime class, but one stable seed (`260904`) and eight oscillatory seeds (`260904`, `260905`, `260911`, `260913`, `260916`, `260918`, `260919`, `260920`) lacked two stationary starts at a common likelihood. Their holdout results remain outside recovery summaries. No starts, thresholds, or model terms were added after inspection. |
